    ...
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4 text-gray-700">
          <div>
            <div className="text-xs uppercase text-gray-500">Case Title</div>
          ...
          {caseData.patientProfile && (
            <div className="border-t pt-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Patient Profile Information</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <div className="text-xs uppercase text-gray-500">Age</div>
                ...
                <div>
                  <div className="text-xs uppercase text-gray-500">Blood Group</div>
                  <div>{caseData.patientProfile.bloodGroup || "Not provided"}</div>
                </div>
                <div>
                  <div className="text-xs uppercase text-gray-500">Height</div>
                  <div>{caseData.patientProfile.height || "Not provided"}</div>
                </div>
                <div>
                  <div className="text-xs uppercase text-gray-500">Weight</div>
                  <div>{caseData.patientProfile.weight || "Not provided"}</div>
                </div>
              </div>
              
              <div className="mt-3">
                <div className="text-xs uppercase text-gray-500">Medical History</div>
                <div>{caseData.patientProfile.medicalHistory || "Not provided"}</div>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                <div>
                  <div className="text-xs uppercase text-gray-500">Current Medications</div>
                  <div>{caseData.patientProfile.currentMedications || "Not provided"}</div>
                </div>
                <div>
                  <div className="text-xs uppercase text-gray-500">Allergies</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                <div>
                  <div className="text-xs uppercase text-gray-500">Emergency Contact</div>
                  <div>{caseData.patientProfile.emergencyContact || "Not provided"}</div>
                </div>
                <div>
                  <div className="text-xs uppercase text-gray-500">Relation</div>
                  <div>{caseData.patientProfile.emergencyContactRelation || "Not provided"}</div>
                </div>
              </div>
              
              <div className="mt-3">
                <div className="text-xs uppercase text-gray-500">Insurance Info</div>
