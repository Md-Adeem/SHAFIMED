...
const teamMembers = [
  {
    ...
    github: "https://github.com/mdadeem",
  ...
  },
  {
    ...
    img: "/images/fraz.jpg",
    linkedin: "https://www.linkedin.com/in/fraz-haidry/",
  ...
  },
  {
    ...
    img: "/images/asif.jpg",
    linkedin: "https://www.linkedin.com/in/md-asif/",
    github: "https://github.com/mdasif",
  ...
  },
  {
    ...
    img: "/images/areeb.jpg",
    linkedin: "https://www.linkedin.com/in/mohd-areeb/",
    github: "https://github.com/mohdareeb",
  ...
  return (
    <section className="bg-gradient-to-b from-white via-green-50 to-white m-10 text-gray-800">
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-20">
        {/* About Intro */}
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            About <span className="text-green-600">ShaafiMed</span>
          </h1>
        ...
        <div className="text-center mb-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
            {[
              ...
              <div
                key={index}
                className="bg-white shadow-md hover:shadow-lg rounded-2xl p-6 border border-gray-100 transition"
              >
        ...
        <div className="text-center mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white shadow-md hover:shadow-lg rounded-2xl p-8 border border-gray-100 transition"
              >
      ...
      <section className="relative py-28 bg-gradient-to-b from-white via-green-50/60 to-white overflow-hidden">
  <div className="absolute inset-0 -z-10 opacity-30 blur-3xl bg-gradient-to-r from-green-100 via-green-200 to-green-100"></div>

  <div className="text-center mb-16">
    <h2 className="text-5xl font-bold text-gray-900 mb-5 tracking-tight">Meet Our Team</h2>
    <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
      The minds behind <span className="text-green-600 font-semibold">ShaafiMed</span> — 
  ...
  <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-14 mb-16">
    {teamMembers.slice(0, 2).map((member, index) => (
      <div
        key={index}
        className="group bg-white/90 backdrop-blur-md rounded-3xl shadow-md hover:shadow-2xl transition transform hover:-translate-y-3 border border-green-100 hover:border-green-300 p-10"
      >
        <div className="relative w-32 h-32 mx-auto mb-6">
          <img
            src={member.img}
            alt={member.name}
            className="w-32 h-32 rounded-full object-cover ring-4 ring-green-100 group-hover:ring-green-300 transition"
          />
        </div>
        <h3 className="text-xl font-semibold text-gray-900 mb-2">{member.name}</h3>
        <p className="text-green-600 text-sm mb-4 font-medium">{member.role}</p>
        ...
        <div className="flex justify-center gap-6 text-gray-500 mt-6">
          ...
          <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition">
            <FaLinkedin size={20} />
          </a>
        </div>
      </div>
  ...
  <div className="mt-24 text-center">
    <div className="inline-flex items-center gap-4 bg-green-100/60 rounded-full px-8 py-4">
