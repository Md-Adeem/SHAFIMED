        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center min-h-[80vh]">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl">
              Connect with world-class doctors, book appointments instantly, and get personalized healthcare at your fingertips.
            </p>
              ...
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Cardiac Surgery Patient</p>
                ...
                <blockquote className="text-gray-700 italic mb-6">
                  "The care I received was exceptional. The doctors were not only highly skilled but also compassionate. I'm grateful for the second chance at life."
                </blockquote>
              </div>
