      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <div className="text-white font-extrabold text-2xl mb-4">ShafiMed</div>
          ...
          {/* Treatments */}
          <div>
            <div className="text-white font-semibold mb-4">{t('treatments.title')}</div>
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Organ Transplant</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Cancer Treatment</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Fertility Treatment</a></li>
            </ul>
          </div>
          
          {/* Quick Links */}
          <div>
            <div className="text-white font-semibold mb-4">{t('footer.quickLinks')}</div>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-white transition-colors">{t('hospitals.title')}</a></li>
              ...
              <li><a href="#" className="hover:text-white transition-colors">Medical Visa</a></li>
          ...
          {/* Contact & Offices */}
          <div>
            <div className="text-white font-semibold mb-4">{t('footer.contact')}</div>
            <div className="space-y-3 text-sm">
              {/* Global Headquarters */}
              <div>
                <div className="font-medium text-white mb-1">Global HQ - Dubai</div>
                <p className="text-gray-400">Business Bay, Dubai, UAE</p>
                <p className="text-gray-400">Phone: +971-4-589-2847</p>
              </div>
              
              {/* Regional Office */}
              <div>
                <div className="font-medium text-white mb-1">Regional Office - Mumbai</div>
                <p className="text-gray-400">Bandra West, Mumbai, India</p>
                <p className="text-gray-400">Phone: +91-22-4015-8920</p>
              </div>
              
              {/* Support Contacts */}
              <div className="border-t border-gray-700 pt-3">
                <p className="text-gray-400">Email: support@shafimed.com</p>
                <p className="text-gray-400">Emergency: +971-50-234-8901</p>
                <p className="text-gray-400">WhatsApp: +971-56-789-1234</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            <div className="text-xs text-gray-500">
              {t('footer.copyright')} | License No: DM-2384-2019 | Est. 2019
            </div>
