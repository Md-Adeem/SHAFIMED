      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <div className="text-white font-extrabold text-2xl mb-4">ShafiMed International</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/hospitals" className="hover:text-white transition-colors">{t('hospitals.title')}</a></li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              {/* Regional Office */}
              <div>
                <div className="font-medium text-white mb-1">Head Office - New delhi</div>
